...
// In-memory data store for products (pre-seeded with our 10 GOTS certified clothing items)
const PRODUCTS = [
  {
    id: 'oatmeal-set',
    ...
    category: 'Sets',
    colors: [
      { name: 'Oatmeal', hex: '#EFECE6', image: '/images/product_oatmeal.png' },
      { name: 'Charcoal', hex: '#333333', image: '/images/product_charcoal_set.png' }
    ],
  ...
  },
  {
    ...
    category: 'Sets',
    colors: [
      { name: 'Honey', hex: '#DCA842', image: '/images/product_honey.png' },
      { name: 'Cream', hex: '#EFECE6', image: '/images/product_cream_set.png' }
    ],
  ...
  },
  {
    ...
    title: 'Tie Dye Set',
    price: 20.00,
    image: '/images/product_tiedye.png',
    category: 'Sets',
    colors: [
      { name: 'Marble Black', hex: '#333333', image: '/images/product_tiedye.png' },
      { name: 'Marble White', hex: '#EFECE6', image: '/images/product_tiedye_white.png' }
    ],
  ...
  },
  {
    ...
    price: 8.50,
    image: '/images/product_socks_white.png',
    category: 'Accessories',
    colors: [
      { name: 'Chalk White', hex: '#FFFFFF', image: '/images/product_socks_white.png' },
      { name: 'Warm Sand', hex: '#EAE3D2', image: '/images/product_socks_sand.png' }
    ],
  ...
  },
  {
    ...
    price: 16.00,
    image: '/images/product_onesie_sage.png',
    category: 'Onesies',
    colors: [
      { name: 'Sage Green', hex: '#8F9E8B', image: '/images/product_onesie_sage.png' },
      { name: 'Desert Sand', hex: '#EAE3D2', image: '/images/product_onesie_sand.png' },
      { name: 'Oatmeal', hex: '#EFECE6', image: '/images/product_onesie_oatmeal.png' }
    ],
  ...
  },
  {
    ...
    price: 12.00,
    image: '/images/product_bib_sage.png',
    category: 'Accessories',
    colors: [
      { name: 'Sage Green', hex: '#8F9E8B', image: '/images/product_bib_sage.png' },
      { name: 'Desert Sand', hex: '#EAE3D2', image: '/images/product_bib_sand.png' },
      { name: 'Honey', hex: '#DCA842', image: '/images/product_bib_honey.png' }
    ],
  ...
  },
  {
    ...
    price: 10.00,
    image: '/images/product_beanie_oatmeal.png',
    category: 'Accessories',
    colors: [
      { name: 'Oatmeal', hex: '#EFECE6', image: '/images/product_beanie_oatmeal.png' },
      { name: 'Sage Green', hex: '#8F9E8B', image: '/images/product_beanie_sage.png' }
    ],
